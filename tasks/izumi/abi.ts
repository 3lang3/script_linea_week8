...
export const limitOrderAbi = [
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'slotIdx', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'orderIdx', type: 'uint256' }],
    name: 'updateOrder',
    outputs: [{ internalType: 'uint256', name: 'earn', type: 'uint256' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  { stateMutability: 'payable', type: 'receive' },
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'uint128', name: 'amountXMin', type: 'uint128' },
          { internalType: 'uint128', name: 'amountYMin', type: 'uint128' },
          { internalType: 'uint256', name: 'deadline', type: 'uint256' },
        ],
